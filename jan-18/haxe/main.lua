...
Main.new = {}
Main.main = function() 
  haxe.Log.trace(10,_hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Main.hx",lineNumber=3,className="Main",methodName="main"}));
end
